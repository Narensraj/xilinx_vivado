...
-- Date        : Fri Nov 28 07:08:13 2025
-- Host        : DESKTOP-GU4IL4Q running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               E:/xilinx_vivado/project_5/project_5.sim/sim_1/synth/func/xsim/ram_tb_func_synth.vhd
-- Design      : ram_4
...
architecture STRUCTURE of ram_4 is
  ...
  signal \dout_OBUFT[3]_inst_i_2_n_0\ : STD_LOGIC;
...
\dout_OBUFT[3]_inst_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \dout_OBUFT[3]_inst_i_2_n_0\,
      O => \dout_TRI[0]\
    );
