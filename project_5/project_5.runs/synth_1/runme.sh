...
HD_PWD='E:/xilinx_vivado/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_4.tcl
