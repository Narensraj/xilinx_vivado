...
HD_PWD='E:/xilinx_vivado/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ram_4.tcl -notrace
