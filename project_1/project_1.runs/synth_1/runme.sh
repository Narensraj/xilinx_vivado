...
HD_PWD='E:/xilinx_vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and_12.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and_12.tcl
