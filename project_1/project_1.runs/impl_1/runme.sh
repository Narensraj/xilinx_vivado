...
HD_PWD='E:/xilinx_vivado/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log and_12.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source and_12.tcl -notrace
