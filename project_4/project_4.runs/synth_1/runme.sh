...
HD_PWD='E:/xilinx_vivado/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_32.tcl
