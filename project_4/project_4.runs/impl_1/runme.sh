...
HD_PWD='E:/xilinx_vivado/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ram_32.tcl -notrace
